<div class="row payment-complete" style="display: none">
    <div class="col-12 col-md-12 col-lg-12 col-sm-12 mx-auto text-center">
                 ...
                 class="sucsssimage"><g>
                    <g>
                        <path d="M26,0C11.664,0,0,11.663,0,26s11.664,26,26,26s26-11.663,26-26S40.336,0,26,0z M26,50C12.767,50,2,39.233,2,26   S12.767,2,26,2s24,10.767,24,24S39.233,50,26,50z"
                              data-original="#000000" class="active-path" data-old_color="#297762" fill="#287661"/>
        ...
        <h2 class="payment-sucss-title">Congratulations!</h2>
        <h3 class="payment-sucss-message">Your purchase was successful.</h3>
    </div>
</div>
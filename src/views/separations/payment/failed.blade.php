<div class="row payment-failed-view" style="display: none">
    <div class="col-12 col-md-12 col-lg-12 col-sm-12 mx-auto text-center">
        <div style="margin-bottom: 30px">

            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1"
                 x="0px" y="0px" viewBox="0 0 486.463 486.463" style="enable-background:new 0 0 486.463 486.463;"
                 xml:space="preserve" class="sucsssimage"><g>
                    <g>
                        <g>
                            <path d="M243.225,333.382c-13.6,0-25,11.4-25,25s11.4,25,25,25c13.1,0,25-11.4,24.4-24.4    C268.225,344.682,256.925,333.382,243.225,333.382z"
                                  data-original="#000000" class="active-path" data-old_color="#000000" fill="#FFCC4D"/>
